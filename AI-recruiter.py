...
# Authentication 
s.login("varangantikavya29@gmail.com","Kavya12345") 
...
data = ResumeParser('PradeepthiResume.pdf').get_extracted_data()
...
if(len(Skills_matched) >= 4 ):
    ...
    TEXT = "Hello " + name + ",\n\nThanks for applying to the job post-AI/ML Developer. Your skill matches our requirements. Kindly, let us know your available time for initial round of interview.\n\nThanks and Regards,\n\nTalent acquisition team | SmartBridge"
    # send mail
    message  = 'Subject: {}\n\n{}'.format(SUBJECT, TEXT)
    #send the mail
    s.sendmail("kavyavaranganti56@gmail.com", email, message) 
    #quit the session
    s.quit()    
else:
